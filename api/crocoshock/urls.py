...
api_v1_urlpatterns = [
    path(
        ...
        include(("crocoshock.apps.accounts.api.v1.urls", "accounts"), namespace="api-v1-accounts"),
    )
]
...
# enable Swagger
if "SWAGGER" in settings.CROCOSHOCK_FEATURES:
    ...
    api_v1_schema_view = get_schema_view(
        openapi.Info(
            title="crocoshock",
            default_version="v1",
            description="crocoshock API v1 description",
        ),
        public=True,
